 ...
 */
export function serializeUploadOptions(uploadOptions) {
    const serialized = { ...uploadOptions };
...
//# sourceMappingURL=serialization-utils.mjs.map